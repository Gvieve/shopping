...
class MarketTest < Minitest::Test
  ...
  def test_total_inventory
    ...
    market.add_vendor(vendor2)
    market.add_vendor(vendor3)
    expected1 = {item1 => {quantity: 100, vendors: [vendor1, vendor3]},
                 item2 => {quantity: 7, vendors: [vendor1]},
                 item4 => {quantity: 50, vendors: [vendor2]},
                 item3 => {quantity: 35, vendors: [vendor2, vendor3]}}

    assert_equal expected1, market.total_inventory
  end
  ...
  def test_it_can_store_date
    market = Market.new("South Pearl Street Farmers Market")

    Market.any_instance.stubs(:date).returns('24/02/2020')
